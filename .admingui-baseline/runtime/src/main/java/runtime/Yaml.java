...
/**
 * Minimal YAML writer for the observation summary: maps, lists and scalars, strings always double-quoted. Same output
 * layout as the inventory extractor's writer so that the files look alike.
 */
final class Yaml {
